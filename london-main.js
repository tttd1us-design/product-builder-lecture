const places = [
  ...
  {
    title: "버킹엄 궁전 (Buckingham Palace)",
  ...
  {
    title: "웨스트민스터 사원 (Westminster Abbey)",
  ...
  {
    title: "피카딜리 서커스 (Piccadilly Circus)",
    summary: "런던의 타임스퀘어",
